...
const translations: Record<Language, Record<string, string>> = {
  it: {
    ...
    "platform.trust.validated": "Scientificamente validati",
    "platform.trust.certified": "Co-progettati con esperti",
    "platform.trust.compliant": "Standard nazionali e internazionali",
  ...
  en: {
    ...
    "platform.trust.validated": "Scientifically validated",
    "platform.trust.certified": "Co-designed with experts",
    "platform.trust.compliant": "National & international standards",
