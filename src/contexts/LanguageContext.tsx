...
const translations: Record<Language, Record<string, string>> = {
  it: {
    ...
    "platform.description": "Co-progettiamo moduli insieme a consulenti certificati ed esperti di dominio. Conformi agli standard nazionali e internazionali.",
    ...
    "platform.happiness.f3": "Assessment basato su modelli scientifici",
    ...
    "platform.care.f1": "Assessment validato",
    ...
    "platform.dei.desc": "Valuta le politiche e la cultura aziendale in tema di parità di genere. Supporta il percorso verso la certificazione UNI/PdR 125:2022.",
  ...
  en: {
    ...
    "platform.description": "We co-design modules with certified consultants and domain experts. Compliant with national and international standards.",
    ...
    "platform.happiness.f3": "Assessment based on scientific models",
    ...
    "platform.care.f1": "Validated assessment",
    ...
    "platform.dei.desc": "Evaluates corporate policies and culture on gender equality. Supports the path to UNI/PdR 125:2022 certification.",
