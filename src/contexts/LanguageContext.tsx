...
const translations: Record<Language, Record<string, string>> = {
  it: {
    ...
    "platform.vibewise.desc": "Assessment scientificamente validato pensato per le persone meno giovani, indipendentemente dalla loro situazione lavorativa. Misura il benessere, le risorse personali e la qualità della vita nell'ottica della silver economy, valorizzando ogni fase della vita adulta.",
  ...
  en: {
    ...
    "platform.vibewise.desc": "Scientifically validated assessment designed for older adults, regardless of their work situation. It measures wellbeing, personal resources, and quality of life within the silver economy framework, valuing every stage of adult life.",
