...
const translations: Record<Language, Record<string, string>> = {
  it: {
    ...
    "platform.vibewise.subtitle": "Silver Economy & Benessere delle Persone Meno Giovani",
    "platform.vibewise.desc": "Assessment scientificamente validato progettato per le persone meno giovani — non solo lavoratori, ma chiunque desideri misurare e valorizzare il proprio benessere nella terza età. Esplora risorse personali, motivazione e qualità della vita nell'ottica della silver economy.",
    "platform.vibewise.f1": "Assessment validato per persone meno giovani",
    "platform.vibewise.f2": "Misurazione del benessere e qualità della vita",
    "platform.vibewise.f3": "Analisi delle risorse e motivazione personale",
    "platform.vibewise.f4": "Valorizzazione del capitale esperienziale",
    "platform.vibewise.f5": "Report personalizzati e percorsi di crescita",
  ...
  en: {
    ...
    "platform.vibewise.subtitle": "Silver Economy & Wellbeing for Older Adults",
    "platform.vibewise.desc": "Scientifically validated assessment designed for older adults — not just workers, but anyone who wants to measure and enhance their wellbeing in later life. Explores personal resources, motivation, and quality of life within the silver economy framework.",
    "platform.vibewise.f1": "Validated assessment for older adults",
    "platform.vibewise.f2": "Wellbeing and quality of life measurement",
    "platform.vibewise.f3": "Personal resources and motivation analysis",
    "platform.vibewise.f4": "Experiential capital enhancement",
    "platform.vibewise.f5": "Personalized reports and growth pathways",
